      ...
      <div class="content">
            <div class="container-fluid">
                  ...
                  <div class="row">
                        <div class="col-md-6">
                              <div class="card">
                                    <div class="card-header" style="background-color: #993C7E; color: white">
                                                ...
                                                <div class="col-md-12">
                                                      <form action="../app/controllers/usuarios/update.php" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                  ...
                                                                  <select name="id_rol"  class="form-control">
                                                                        ...
                                                                        foreach ($roles_datos as $roles_dato) { 
                                                                              ...
                                                                              <option value="<?php echo $id_rol ?>" <?php if($rol_tabla == $rol){ ?> selected="selected" <?php } ?> ><?php echo $roles_dato["rol"]; ?> </option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                        </option>
                                                            ...
                                                            <div class="form-group">
                                                                  ...
                                                                  <button type="submit" class="btn" style="background-color: #993C7E; color: white">Actualizar</button>
                                                            </div>
                                                      </form>
